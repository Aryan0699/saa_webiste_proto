        ...
        <div className="item-rtl item-rtl1">
          <div className="image-holder ">
            <a href="https://www.instagram.com/techhacksbyn.nirmal/">
              <img className="image" src="AlumniChannel/marquee_nirmal.jpeg" alt="Nirmal Kumawat"/>
            </a>
          </div>
          <div className="Text">
        ...
        <div className="item-rtl item-rtl2">
          <div className="image-holder ">
            <a href="https://www.instagram.com/lalchandbisu/">
              <img className="image" src="AlumniChannel/marquee_lalchand.jpeg" alt="Lal Chand Bisu"/>
            </a>
          </div>
          <div className="Text">
            <h3 className="text-xl font-bold tracking-tight text-black">
        ...
        <div className="item-rtl item-rtl3">
          <div className="image-holder ">
            <a href="https://www.instagram.com/_vinod92/">
              <img className="image" src="AlumniChannel/marquee_vinod.jpeg" alt="Vinod Kumar Meena" />
            </a>
          </div>
          <div className="Text">
            <h3 className="text-xl font-bold tracking-tight text-black">
        ...
        <div className="item-rtl item-rtl4">
          <div className="image-holder ">
            <a href="https://www.instagram.com/_vikasgoyal/">
              <img className="image" src="AlumniChannel/marquee_vikas.jpeg" alt="Vikas Goyal"/>
            </a>
          </div>
          <div className="Text">
            <h3 className="text-xl font-bold tracking-tight text-black">
        ...
        <div className="item-rtl item-rtl5">
          <div className="image-holder ">
            <a href="https://www.linkedin.com/in/tapishr?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3BjFBrZYcFR3%2BJ8fZ8isjksA%3D%3D">
              <img className="image" src="AlumniChannel/marquee_tapish.jpeg" alt="Tapish Rathore"/>
            </a>
          </div>
          <div className="Text">
            <h3 className="text-xl font-bold tracking-tight text-black">
        ...
        <div className="item-rtl item-rtl6">
          <div className="image-holder ">
            <a href="https://www.linkedin.com/in/hustler-utkarsh?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3BdzCE2Yl3QpWbWfKxhSft8w%3D%3D">
              <img className="image" src="AlumniChannel/marquee_utkarsh.jpeg" alt="Utkarsh Trivedi"/>
            </a>
          </div>
          <div className="Text">
            <h3 className="text-xl font-bold tracking-tight text-black">
        ...
        <div className="item-rtl item-rtl7">
          <div className="image-holder ">
            <a href="https://www.instagram.com/sethi.tanmay/">
              <img className="image" src="AlumniChannel/marquee_tanmay.jpeg" alt="Tanmay Sethi" />
            </a>
          </div>
          <div className="Text">
            <h3 className="text-xl font-bold tracking-tight text-black">
        ...
        <div className="item-rtl item-rtl9">
          <div className="image-holder ">
            <a href="https://www.linkedin.com/in/himanshujaiswal1?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3BV8T7zjq7Se6NWWj12grYpA%3D%3D">
              <img className="image" src="AlumniChannel/marquee_himanshu.jpeg" alt="Himanshu Jaiswal"/>
            </a>
          </div>
          <div className="Text">
            <h3 className="text-xl font-bold tracking-tight text-black">
        ...
        <div className="item-ltr item-ltr1">
          <div className="image-holder ">
            <a href="linkedin.com/in/gsmanu007">
              <img className="image" src="AlumniChannel/marquee_gurjot.jpeg" alt="Gurjot Singh"/>
            </a>
          </div>
          <div className="Text">
            <h3 className="text-xl font-bold tracking-tight text-black">
        ...
        <div className="item-ltr item-ltr2">
          <div className="image-holder ">
            <a href="linkedin.com/in/sinisterlight">
              <img className="image" src="AlumniChannel/marquee_shobhit.jpeg" alt="Shobit Srivastava"/>
            </a>
          </div>
          <div className="Text">
            <h3 className="text-xl font-bold tracking-tight text-black">
        ...
        <div className="item-ltr item-ltr3">
          <div className="image-holder ">
            <a href="linkedin.com/in/darshan-joshi-5947033b">
              <img className="image" src="AlumniChannel/marquee_darshan.jpeg" alt="Darshan Joshi"/>
            </a>
          </div>
          <div className="Text">
            <h3 className="text-xl font-bold tracking-tight text-black">
        ...
        <div className="item-ltr item-ltr4">
          <div className="image-holder ">
            <a href="linkedin.com/in/surajn-ai">
              <img className="image" src="AlumniChannel/marquee_suraj.jpeg" alt="Suraj Nadipelly"/>
            </a>
          </div>
          <div className="Text">
            <h3 className="text-xl font-bold tracking-tight text-black">
        ...
        <div className="item-ltr item-ltr5">
          <div className="image-holder ">
            <a href="linkedin.com/in/siddarthjn">
              <img className="image" src="AlumniChannel/marquee_siddharth.jpeg" alt="Siddharth Jain"/>
            </a>
          </div>
          <div className="Text">
            <h3 className="text-xl font-bold tracking-tight text-black">
        ...
        <div className="item-ltr item-ltr6">
          <div className="image-holder ">
            <a href="linkedin.com/in/manu-agarwal-21b2964b">
              <img className="image" src="AlumniChannel/marquee_manu.jpeg" alt="Manu Agrawal"/>
            </a>
          </div>
          <div className="Text">
            <h3 className="text-xl font-bold tracking-tight text-black">
        ...
        <div className="item-ltr item-ltr7">
          <div className="image-holder ">
            <a href="linkedin.com/in/shivamverma1006">
              <img className="image" src="AlumniChannel/marquee_shivam.jpeg" alt="Shivan Verma"/>
            </a>
          </div>
          <div className="Text">
            <h3 className="text-xl font-bold tracking-tight text-black">
        ...
        <div className="item-ltr item-ltr9">
          <div className="image-holder ">
            <a href="linkedin.com/in/aditya-ranjan-77305571">
              <img className="image" src="AlumniChannel/marquee_aditya.jpeg" alt="Aditya Ranjan"/>
            </a>
          </div>
          <div className="Text">
            <h3 className="text-xl font-bold tracking-tight text-black">
